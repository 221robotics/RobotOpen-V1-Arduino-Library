...
/* I/O Setup */
USBJoystick usb1('0');  // Assign the Xbox 360 USBJoystick object to bundle 0
...
void enabled() {
  ...
  int leftDrive = usb1.makePWM(XBOX_RIGHTY, INVERT) - (127 - usb1.makePWM(XBOX_RIGHTX, NORMAL));
  int rightDrive = usb1.makePWM(XBOX_RIGHTY, INVERT) + (127 - usb1.makePWM(XBOX_RIGHTX, NORMAL));
